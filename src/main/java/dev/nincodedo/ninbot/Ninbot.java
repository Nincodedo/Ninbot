...
public class Ninbot {
    ...
    private static final org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(Ninbot.class);
    @Autowired
    ...
    public CommandLineRunner commandLineRunner(ApplicationContext context) {
        return args -> {
            final java.util.List<net.dv8tion.jda.api.JDA> shards = shardManager.getShards();
            ...
            shardManager.getShards().forEach(jda -> {
                try {
                    ...
                    for (Guild guild : jda.getGuilds()) {
                        log.info("Server ID: {}, Server Name: {}, Owner ID: {}, Owner Name: {}", guild.getId(), guild.getName(), guild.getOwnerId(), guild.getOwner().getEffectiveName());
                        statManager.recordCount("serverMemberCount", StatCategory.SERVER, guild.getId(), guild.getMemberCount());
                    }
