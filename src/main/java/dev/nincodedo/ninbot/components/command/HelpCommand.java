...
public class HelpCommand extends AbstractCommand {
    ...
    private static final org.apache.logging.log4j.Logger log =
            org.apache.logging.log4j.LogManager.getLogger(HelpCommand.class);
    ...
    public MessageAction executeCommand(MessageReceivedEvent event) {
        ...
        embedBuilder.setTitle(resourceBundle.getString("command.help.message.title")).setColor(Color.BLUE);
        ...
        keyList.stream()
                ...
                .forEach(commandName -> {
                    final dev.nincodedo.ninbot.components.command.AbstractCommand command = commandMap.get(commandName);
        ...
        messageAction.addPrivateMessageAction(embedBuilder.build()).addSuccessfulReaction();
